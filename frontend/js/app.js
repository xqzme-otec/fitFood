...
(function () {
  ...
  // Должны совпадать с FridgeCategory на бэкенде (app/models/enums.py).
  const FRIDGE_CATS = ["Мясо и рыба", "Готовая еда", "Молочка", "Бакалея", "Сладости", "Снеки", "Овощи и фрукты", "Чай, кофе, какао", "Напитки", "Прочее"];
  const DEMO_RECEIPT =
